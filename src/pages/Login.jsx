...
//                 <h1 className="heading-2 text-center spacer-md">Welcome to TheSpark</h1>
//                 <p className="text-body text-center spacer-lg">
//                     Save daily. Earn 5%. Rise together.
//                 </p>
...
//                 Don't have an account? <Link to="/register" className="text-spark-500">Sign up</Link>
//             </p>
